  ...
  return (
    <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-zinc-950">Reset your password</h1>
      ...
      <p className="mt-6 text-center text-sm text-zinc-600">
        <Link href="/login" className="font-medium text-zinc-950">Back to sign in</Link>
      </p>
    </section>
  );
}
