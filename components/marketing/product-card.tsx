  ...
  return (
    <article className="group">
      <div className="relative aspect-[4/5] overflow-hidden bg-[#eee9e1]">
        ...
        <Link href="#" className="absolute right-4 top-4 grid size-10 place-items-center rounded-full bg-white/90 text-[#302b26] opacity-0 shadow-sm transition-opacity group-hover:opacity-100" aria-label={`View ${name}`}>
